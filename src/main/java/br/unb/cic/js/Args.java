...
public class Args {
    @Parameter(names = { "-d",
            "--directory" }, required = true, description = "The path to a/set of git repository(ies) containing JS code")
    ...
    @Parameter(names = { "-pt",
            "--project-threads" }, description = "How many threads to use when processing multiple projects")
    public Integer threadsProjects = 1;

    @Parameter(names = { "-ft",
            "--files-threads" }, description = "How many threads to use when analyzing a project (defaults to number of processors")
    ...
    public String endDate = "31-12-2023";

...
public class Summary {
    ...
    public static String header() {
        ...
        h.append("project,date,revision,files")
                ...
                .append(",computed-property-assignment")
                .append(",function-property-declaration")
				.append(",for-of-statements")
				.append(",for-await-of")
				.append(",static-block-in-classes")
				.append(",optional-catch-binding-declarations")
				.append(",private_methods")
				.append(",assignment-operators")
				.append(",spread-in-objects")
				.append(",rest-in-objects")
				...
				.append(",for-of-statements-files")
				.append(",for-await-of-files")
				.append(",static-block-in-classes-files")
				.append(",optional-catch-binding-declarations-files")
				.append(",private_methods-files")
				.append(",assignment-operators-files")
				.append(",spread-in-objects-files")
				.append(",rest-in-objects-files")
                .append(",errors")
                .append(",statements\n");

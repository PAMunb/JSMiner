...
public final class DirectoriesRule {
    ...
    private static final String[] directories = {".git","lib", "packages", "package", "vendor", "node_modules", "libs", "coverage", "build", "bin", "stories", "dist", "external", "3rdParty", "thirdparty", "third-party"};

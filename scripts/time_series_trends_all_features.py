...
for feature in features:
    ...
    sns.lineplot(data=total_by_month, x='year_month', y='loess', label=f'{feature.replace("_", " ").title()} - Smoothed Trend', errorbar=None, estimator=None, lw=2)

# Configurações do gráfico
plt.title('Trends of Different Features')
